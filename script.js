...
function addBook() {
  ...
  if (name && sector) {
    ...
    cell4.innerHTML =
      '<button type="button" class="btn btn-info m-2" data-bs-toggle="modal" data-bs-target="#edit">Edit</button><button type="button" class="btn btn-danger" onclick="delete()">Delete</button>';
...
window.addEventListener("load", function () {
  ...
  books.forEach(function (bookData) {
    ...
    cell4.innerHTML =
      '<button type="button" class="btn btn-info m-2" data-bs-toggle="modal" data-bs-target="#edit" onclick="editBook(this)">Edit</button><button type="button" class="btn btn-danger" onclick="del(this)">Delete</button>';
  });
});
function del(sup) {
